...
## Overview
AI Medical Report Extractor is a Streamlit application that analyzes medical reports and extracts structured information using a local LLM through Ollama. It converts unstructured medical text into organized insights such as patient details, risk assessment, and a medical summary while running completely locally.
